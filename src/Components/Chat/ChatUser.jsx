...
return (
  ...
  <div className="md:flex w-full">
      <div className="md:w-1/3 mt-16 f ">
          <div className=" hidden md:block ml-2  rounded-2xl bg-gray-100  " >
      ...
      <div className="md:mt-10 flex h-screen antialiased text-gray-800">
