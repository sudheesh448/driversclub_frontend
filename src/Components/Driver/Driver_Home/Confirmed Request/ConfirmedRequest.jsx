...
<div key={trip.id}  onClick={() => {
navigate(`/trip_request_detail/${trip.trip_id}`);
}} className="bg-sky-800 border  font-semibold grid md:grid-cols-5 gap-2 text-white cursor-pointer transform transition-transform hover:scale-105  hover:text-black hover:bg-orange-200">
